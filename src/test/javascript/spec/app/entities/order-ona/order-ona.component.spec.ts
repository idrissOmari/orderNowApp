...
import { OrderOnaComponent } from 'app/entities/order-ona/order-ona.component';
...
describe('Component Tests', () => {
  describe('OrderOna Management Component', () => {
    let comp: OrderOnaComponent;
    let fixture: ComponentFixture<OrderOnaComponent>;
    let service: OrderOnaService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [OrderNowAppTestModule],
        declarations: [OrderOnaComponent],
        providers: [
          {
        ...
        .overrideTemplate(OrderOnaComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(OrderOnaComponent);
