...
import { ProductComponentsPage, ProductDeleteDialog, ProductUpdatePage } from './product-ona.page-object';
...
describe('Product e2e test', () => {
  ...
  it('should load Products', async () => {
    await navBarPage.goToEntity('product-ona');
  ...
  it('should create and save Products', async () => {
    ...
    await promise.all([
      ...
      productUpdatePage.menuCategorySelectLastOption(),
      productUpdatePage.formulaSelectLastOption()
    ]);
