...
public class MenuResourceIT {
    ...
    private static final String DEFAULT_TITTLE = "AAAAAAAAAA";
    private static final String UPDATED_TITTLE = "BBBBBBBBBB";
    ...
    public void createMenu() throws Exception {
        ...
        assertThat(testMenu.getTittle()).isEqualTo(DEFAULT_TITTLE);
    }
    ...
    public void getAllMenus() throws Exception {
        ...
        restMenuMockMvc.perform(get("/api/menus?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].tittle").value(hasItem(DEFAULT_TITTLE)));
    }
    ...
    public void getMenu() throws Exception {
        ...
        restMenuMockMvc.perform(get("/api/menus/{id}", menu.getId()))
            ...
            .andExpect(jsonPath("$.tittle").value(DEFAULT_TITTLE));
    }
    ...
    public void updateMenu() throws Exception {
        ...
        Menu testMenu = menuList.get(menuList.size() - 1);
        assertThat(testMenu.getTittle()).isEqualTo(UPDATED_TITTLE);
    }
