...
/**
 * REST controller for managing {@link fr.omatech.ordernow.domain.ProductOrder}.
 */
@RestController
@RequestMapping("/api")
public class ProductOrderResource {
    ...
    public ResponseEntity<ProductOrderDTO> updateProductOrder(@RequestBody ProductOrderDTO productOrderDTO) throws URISyntaxException {
